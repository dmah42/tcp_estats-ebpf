...
- [x] TCP_ESTATS_PERF_TABLE_SEGSRETRANS,
- [x] TCP_ESTATS_PERF_TABLE_OCTETSRETRANS,
- [x] TCP_ESTATS_PERF_TABLE_SEGSIN,
- [x] TCP_ESTATS_PERF_TABLE_DATASEGSIN,
- [x] TCP_ESTATS_PERF_TABLE_DATAOCTETSIN,
- [x] TCP_ESTATS_PERF_TABLE_NORMALRTTM,
- [x] TCP_ESTATS_PERF_TABLE_HIGHRTTM,
- [ ] /*		ElapsedSecs */
- [ ] /*		ElapsedMicroSecs */
- [ ] /*		StartTimeStamp */
- [ ] /*		CurMSS */
- [ ] /*		PipeSize */
- [x] TCP_ESTATS_PERF_TABLE_MAXPIPESIZE,
- [ ] /*		SmoothedRTT */
- [ ] /*		CurRTO */
- [x] TCP_ESTATS_PERF_TABLE_CONGSIGNALS,
- [ ] /*		CurCwnd */
- [ ] /*		CurSsthresh */
...
- [x] TCP_ESTATS_PATH_TABLE_IPTTL,    // u8
- [x] TCP_ESTATS_PATH_TABLE_IPTOSIN,  // u8
- [x] TCP_ESTATS_PATH_TABLE_PRECONGSUMCWND,
- [x] TCP_ESTATS_PATH_TABLE_PRECONGSUMRTT,
...
- [x] TCP_ESTATS_STACK_TABLE_MAXSSTHRESH,
- [x] TCP_ESTATS_STACK_TABLE_MINSSTHRESH,
- [x] TCP_ESTATS_STACK_TABLE_DUPACKSIN,
...
- [x] TCP_ESTATS_STACK_TABLE_FASTRETRAN,
...
- [x] TCP_ESTATS_STACK_TABLE_SNDINITIAL,
