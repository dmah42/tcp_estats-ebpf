...
enum tcp_estats_operation {
  ...
  TCP_ESTATS_OPERATION_INC,
  TCP_ESTATS_OPERATION_DEC,
};

enum tcp_estats_variable {
  ...
  TCP_ESTATS_PATH_TABLE_PTTL,
  TCP_ESTATS_PATH_TABLE_PTOSIN,
